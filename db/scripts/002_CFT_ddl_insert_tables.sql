insert into VID_DEBT values  (nextval('serial'), 'МСФО. Корректировка резерва срочной задолженности', 'CR_IFRS_CORR_REZ');
insert into VID_DEBT values  (nextval('serial'), 'МСФО. Денежный поток', 'CR_IFRS_FLOW');
insert into VID_DEBT values  (nextval('serial'), 'Сумма полного досрочного погашения', 'FULL_EARLY_REPAYMENT');
insert into VID_DEBT values  (nextval('serial'),'Плановая сумма погашения', 'SUM_DEBTS_ALL');
insert into VID_DEBT values  (nextval('serial'),'Резерв по срочной задолженности', 'V_РЕЗЕРВ');
insert into VID_DEBT values  (nextval('serial'),'Аванс Неучтенные проценты за кредит', 'АВАНС_НЕУЧТЕН_ПРОЦЕНТЫ');
insert into VID_DEBT values  (nextval('serial'),'Ссудная задолженность', 'КРЕДИТ');
insert into VID_DEBT values  (nextval('serial'),'Вынесено кредита на просрочку', 'КРЕДИТ_ВЫНЕС');
insert into VID_DEBT values  (nextval('serial'),'Кредит + просрочка', 'КРЕДИТ_ПОЛН');
insert into VID_DEBT values  (nextval('serial'),'Неучтенные проценты за кредит', 'НЕУЧТЕН_ПРОЦЕНТЫ');
insert into VID_DEBT values  (nextval('serial'),'Отложенные проценты', 'ОТЛОЖЕН_ПРОЦЕНТЫ');
insert into VID_DEBT values  (nextval('serial'),'Погашено кредита', 'ПОГАШЕНО_КР');
insert into VID_DEBT values  (nextval('serial'),'Погашено процентов', 'ПОГАШЕНО_ПР');
insert into VID_DEBT values  (nextval('serial'),'Погашено просроченного кредита', 'КРЕДИТ_ПР_ГАШ');
insert into VID_DEBT values  (nextval('serial'),'Просроченная ссудная задолженность', 'ПРОСРОЧ_КРЕДИТ');
insert into VID_DEBT values  (nextval('serial'),'Резерв', 'РЕЗЕРВ');
insert into VID_DEBT values  (nextval('serial'),'Резерв. сформированный за счет себестоимости', 'РЕЗЕРВ_СЕБЕСТ');
insert into VID_DEBT values  (nextval('serial'),'Учтенные проценты за кредит', 'УЧТЕН_ПРОЦЕНТЫ');
